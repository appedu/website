...
<div id="page-container" class="row">
    ...
    <div class="studentssubjects index">
        <div class='.col-md-12'>
            ...
            <h2><?php echo __('Student Subjects Studying'); ?></h2>
        </div>
            ...
            <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php foreach ($studentssubjects as $studentssubject): ?>
                        <tr>
                            <td><?php echo h($studentssubject['User']['username']); ?>&nbsp;</td>
                            <td><?php echo h($studentssubject['Subject']['description']); ?>&nbsp;</td>

                            <td class="actions">
                                <div class='btn-group'>			<?php echo $this->Html->link(__(''), array('action' => 'view', $studentssubject['StudentsSubject']['id']), array('class' => 'btn btn-success icon-eye-open')); ?>
                                    <?php echo $this->Html->link(__(''), array('action' => 'edit', $studentssubject['StudentsSubject']['id']), array('class' => 'btn btn-warning icon-edit')); ?>
