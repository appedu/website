                        ...
                        <div class="btn-group">
                            <div class="dropdown-toggle" data-toggle="dropdown">
                                <div id='notification' class="item_icon" style="position: relative">
                                    ...
                                    <?php
                                    echo $this->Html->image('icon/icon_notification_gray.png', array('height' => '36',
                                        'width' => '36'));
                                    ?>
...
<div class="main_content" id="main_content"></div>
<div class="side_content">
    <div class="content_part"><?php echo $this->Html->image('icon/icon_circle_withbase.png'); ?></div>
    <div class="content_part"><h3>Link Circle</h3></div>
    <div class="content_part">you can connect people in circles,<br/>and drag post into circles for sharing.</div>
    <div class="link_circles" id="link_circles" <?php echo (AuthComponent::user('username') != '') ? 'isLogin="true"' : ''; ?>>
        <div class="content_part"><?php echo $this->Html->image('icon/icon_next_step.png'); ?><p>&nbsp;</p></div>
        <div class="content_part"><a class="login_pop"><?php echo $this->Html->image('index_top_login.png', array('alt' => "Archive", 'class' => "appedu_button_img")); ?></a></div>
        <div class="content_part">&nbsp;</div>
        <div class="content_part">Feature requires login.</div>
    </div>
</div>
<div class="clear"></div>
