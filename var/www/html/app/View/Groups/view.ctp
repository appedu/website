	...
	<div class="groups view">
		<div class='.col-md-12'>
			<div class="btn-group pull-right">		
						<?php echo $this->Html->link(__(''), array('action' => 'edit', $group['Group']['id']), array('class' => 'icon-edit btn btn-warning')); ?>
...
</tr><tr>		<td><strong><?php echo __('Focus'); ?></strong></td>
		<td>
			<?php echo $this->Html->link($group['Focus']['abbr'], array('controller' => 'foci', 'action' => 'view', $group['Focus']['id']), array('class' => '')); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('File Cover Dir'); ?></strong></td>
		<td>
			<?php echo h($group['Group']['file_cover_dir']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('File Cover'); ?></strong></td>
		<td>
			<?php echo h($group['Group']['file_cover']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('File Profile Dir'); ?></strong></td>
		<td>
			<?php echo h($group['Group']['file_profile_dir']); ?>
			&nbsp;
		</td>
</tr><tr>		<td><strong><?php echo __('File Profile'); ?></strong></td>
		<td>
			<?php echo h($group['Group']['file_profile']); ?>
			&nbsp;
		</td>
