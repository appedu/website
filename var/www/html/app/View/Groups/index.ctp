...
<?php foreach ($groups as $group): ?>
	<tr>
		...
		<td><?php echo h($group['Group']['file_cover_dir']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['file_cover']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['file_profile_dir']); ?>&nbsp;</td>
		<td><?php echo h($group['Group']['file_profile']); ?>&nbsp;</td>
