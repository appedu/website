	...
	<div class="topics view">
		<div class='.col-md-12'>
			<div class="btn-group pull-right">		
						<?php echo $this->Html->link(__(''), array('action' => 'edit', $topic['Topic']['id']), array('class' => 'icon-edit btn btn-warning')); ?>
		...
		<td>
			<?php echo $this->Html->link($topic['Subject']['abbr'], array('controller' => 'subjects', 'action' => 'view', $topic['Subject']['id']), array('class' => '')); ?>
			&nbsp;
		</td>
