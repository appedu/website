	...
	<div class="users form">
		...
		<?php echo $this->Form->create('User', array('type'=>'file', 'role' => 'form', 
			...
			<fieldset>
					...
					<?php echo $this->Form->input('slug', array('class' => 'form-control', 'required'=>false)); ?>
					
					<?php echo $this->Form->input('password', array('class' => 'form-control')); ?>
					
					<?php echo $this->Form->input('password_token', array('class' => 'form-control', 'required'=>false)); ?>
					
					<?php echo $this->Form->input('email', array('class' => 'form-control')); ?>
					
					<?php echo $this->Form->input('email_verified', array('class' => 'form-control')); ?>
					
					<?php echo $this->Form->input('email_token', array('class' => 'form-control', 'required'=>false)); ?>
					
					<?php echo $this->Form->input('email_token_expires', array('class' => 'form-control', 'required'=>false)); ?>
					...
					<?php echo $this->Form->input('form_and_class', array('class' => 'form-control', 'required'=>false)); ?>
					
					<?php echo $this->Form->input('gender', array('class' => 'form-control', 'required'=>false)); ?>
