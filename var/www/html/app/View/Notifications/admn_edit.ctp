...
<div id="page-container" class="row">
    ...
    <div class='.col-md-12'>
        <div class="btn-group pull-right">
            ...
            <?php echo $this->Form->postLink(__(''), array('action' => 'delete', 
                $this->Form->value('Notification.id')), array('class' => 'icon-trash btn btn-danger'), 
                    __('Are you sure you want to delete # %s?', $this->Form->value('Notification.id'))); ?>
            
            <?php echo $this->Html->link(__(''), array('action' => 'index'), array('class' => 'btn icon-undo')); ?>
        </div><!-- /.btn-group pull-right -->
        <h2><?php echo __('Admin Edit Notification'); ?></h2>
    </div>

    <div class="notifications form">

        <?php
        echo $this->Form->create('Notification', array('role' => 'form',
            'inputDefaults' => array(
                'div' => array(
                    'class' => 'form-group'
                ), 'label' => array(
        ...
        <fieldset>
            ...
            <?php
            echo $this->Form->input('isChecked', array(
            ...
            <?php
            echo $this->Form->input('isPushed', array(
                'class' => 'ace ace-switch',
                'between' => '<div class=\'col-xs-5\'><label>',
                'after' => '<span class=\'lbl\'></span></label></div>',
            ));
