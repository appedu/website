	...
	<div class="<?php echo $pluralVar; ?> view">
		<div class='.col-md-12'>
			<div class="btn-group pull-right">		
				<?php
					echo "\t\t<?php echo \$this->Html->link(__(''), array('action' => 'edit', \${$singularVar}['{$modelClass}']['{$primaryKey}']), array('class' => 'icon-edit btn btn-warning')); ?>\n";
					...
					echo "\t\t<?php echo \$this->Html->link(__(''), array('action' => 'add'), array('class' => 'btn btn-primary icon-plus')); ?>\n";
					echo "\t\t<?php echo \$this->Html->link(__(''), array('action' => 'index'), array('class' => 'btn btn-default icon-undo')); ?>\n";
				?>	
						...
						<tbody>
							...
							echo "\t<?php
									...
									echo "\t\t<tr>\n";
										...
										echo "\t\t\t\t<?php echo \$this->Html->link(__(''), array('controller' => '{$details['controller']}', 'action' => 'view', \${$otherSingularVar}['{$details['primaryKey']}']), array('class' => 'btn btn-success icon-eye-open')); ?>\n";
										echo "\t\t\t\t<?php echo \$this->Html->link(__(''), array('controller' => '{$details['controller']}', 'action' => 'edit', \${$otherSingularVar}['{$details['primaryKey']}']), array('class' => 'btn btn-warning icon-edit')); ?>\n";
										echo "\t\t\t\t<?php echo \$this->Form->postLink(__(''), array('controller' => '{$details['controller']}', 'action' => 'delete', \${$otherSingularVar}['{$details['primaryKey']}']), array('class' => 'btn btn-danger icon-trash'), __('Are you sure you want to delete # %s?', \${$otherSingularVar}['{$details['primaryKey']}'])); ?>\n";
										echo "\t\t\t</td>\n";
									echo "\t\t</tr>\n";
